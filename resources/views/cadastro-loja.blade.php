...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-12 text-center" style="margin-bottom: 40px">
            <h2 class="text-danger">Aten&ccedil;&atilde;o!!!</h2>
            <h5><strong>Preencha os dados abaixo para se cadastrar no sistema. Ap&oacute;s o cadastro voc&ecirc; ser&aacute; direcionado para seu painel de controle e poder&aacute; cadastrar quantas lojas desejar.</strong></h5>
        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <label style="padding-top: 6px;">
                                        <input type="radio" name="perfil_id" value="3" checked>Dono de Loja
                                        {{--<input style="margin-left: 10px;" type="radio" name="perfil_id" value="2">Cliente--}}
                                    </label>
                                </div>
                            </div>
                        </div>
