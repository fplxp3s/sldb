...
@section('content')
    ...
    <form id="form-nova-loja" class="form-horizontal" method="post" action="{{ action('LojaController@adiciona') }}">
        ...
        <div class="form-group{{ $errors->has('cpf_representante') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="cpf_representante" type="text" class="form-control" name="cpf_representante" value="{{ old('cpf_representante') }}" required placeholder="123.456.789-10" maxlength="14">
        ...
        <div class="form-group{{ $errors->has('cnpj') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="cnpj" type="text" class="form-control" name="cnpj" value="{{ old('cnpj') }}" required placeholder="12.345.678/9101" maxlength="16">
        ...
        <div class="form-group{{ $errors->has('telefone') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="telefone" type="text" class="form-control" name="telefone" value="{{ old('telefone') }}" required placeholder="(21)12356-6531" maxlength="14">
        ...
        <div class="form-group{{ $errors->has('telefone2') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="telefone2" type="text" class="form-control" name="telefone2" value="{{ old('telefone2') }}" placeholder="(21)12356-6531" maxlength="14">
