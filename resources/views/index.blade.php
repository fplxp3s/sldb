            ...
            @foreach($produtos as $produto)
                <div class="col-sm-3 col-md-3">
                    <div class="thumbnail" title="{{$produto->nome}}">
                        <a href="{{action('SiteController@exibeDetalhesProduto', $produto->nome)}}"><img class="img-thumbnail img-default-size" src="{{Illuminate\Support\Facades\Storage::url($produto->foto->nome_arquivo)}}" alt="{{$produto->nome}}"></a>
